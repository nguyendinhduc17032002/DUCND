...
cred = credentials.Certificate('./iuh-20002955-firebase-adminsdk-zckw5-4631f89324.json')
appLoadData = firebase_admin.initialize_app(cred)

dbFireStore = firestore.client()

queryResults = list(dbFireStore.collection(u'tb-20002955').stream())
    ...
    children=[
        html.Div(
            children=[
                ...
                html.H4(
                    "IUH-DHHTTT16C-20002955-Nguyễn Đình Đức", className="header-title"
                )
            ],
            className="header",
        ),
